...
void ROGGCLoweringImpl::replaceMemSet(CallInst *ir) {
    ...
    CallInst *call = CallInst::Create(
        Intrinsic::getOrInsertDeclaration(ir->getModule(), Intrinsic::memset, { mem->getType(), len->getType() }),
...
void ROGGCLoweringImpl::replaceMemXfer(CallInst *ir, Intrinsic::ID iid) {
    ...
    CallInst *call = CallInst::Create(
        Intrinsic::getOrInsertDeclaration(ir->getModule(), iid, { mem->getType(), src->getType(), len->getType() }),
